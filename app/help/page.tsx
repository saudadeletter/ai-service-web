...
export default function HelpPage() {
  return (
    <div className="container page-shell help-page">
      ...
      <div className="help-grid">
        ...
        <aside className="panel help-guide">
          <span className="eyebrow">服务前，先了解</span>
          <h2>清楚约定，安心开始。</h2>
          <p className="help-guide-intro">
            先咨询、再确认方案。展开查看办理、收退款与信息使用说明。
          </p>
          <HelpDisclosure id="service-scope" title="当前服务与办理方式">
            <p>
              你可以浏览套餐、提交需求，由管理员沟通后确认成交，并用原需求编号与查询码查看订单和交付。“仅生成本地草稿”不会上传内容；正式提交后会保存到本站数据库。
            </p>
          </HelpDisclosure>
          <HelpDisclosure id="payments" title="收款与退款说明">
            <p>
              网站尚未提供在线支付。订单中的收退款金额由管理员核对实际交易后登记，页面操作不会扣款或执行退款。具体成交价、交付范围和退款约定以双方沟通确认为准。
            </p>
          </HelpDisclosure>
          <HelpDisclosure id="privacy" title="信息使用说明">
            <p>
